        ...
        <div className="quaternary_container">
          <article className="section_block incident">
            ...
            <div className="text">
              ...
              <p>
                ...
                Com apenas alguns cliques, informe sua comunidade sobre o que
                está acontecendo e ajude a manter todos em alerta.
              </p>
            </div>
          </article>
          ...
          <article className="section_block notices">
            <div className="text">
              ...
              <p>
                ...
                acontecendo na sua área e pode agir com rapidez quando
                necessário.
              </p>
            </div>
            <figure className="figure_app_uri">
          ...
          <article className="section_block emergence">
            ...
            <div className="text">
              ...
              <p>
                Em situações de emergência, use o botão SOS para enviar um
                alerta instantâneo a todos os moradores do bairro. Seja um
                incêndio, assalto ou desastre, todos ficarão informados e
                poderão tomar medidas rápidas para se proteger.
              </p>
            </div>
          </article>
